...
use crate::layout_error::LayoutError;
...
mod tests {
    use super::*;
    use crate::layout::{Direction, LayoutProps, RectOffset, Size, SizeCalc, SizeConstraint};
    use crate::text;
    ...
    impl Widget for TestText {
        ...
        ) -> crate::screen::VirtualScreen {
            let mut s =
                crate::screen::VirtualScreen::new(text::measure_width(&self.text).max(1), 1);
            s.write_str(
                0,
                0,
                &self.text,
    ...
    impl Widget for TestBox {
        ...
        fn measure_subtree(
            ...
            SizeConstraint {
                ...
                max_w: crate::layout::AxisConstraint::Fixed(_available.w),
                max_h: crate::layout::AxisConstraint::Fixed(_available.h),
            }
        }
    }
