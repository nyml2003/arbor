...
mod tests {
    ...
    const SNAPSHOT: &[(&str, &str)] = &[
        (
            "SOURCE.md",
            include_str!("../../../assets/pokeapi-current-data/SOURCE.md"),
        ),
        (
            "languages.csv",
            include_str!("../../../assets/pokeapi-current-data/languages.csv"),
        ),
        (
            "version_groups.csv",
            include_str!("../../../assets/pokeapi-current-data/version_groups.csv"),
        ),
        (
            "stats.csv",
            include_str!("../../../assets/pokeapi-current-data/stats.csv"),
        ),
        (
            "types.csv",
            include_str!("../../../assets/pokeapi-current-data/types.csv"),
        ),
        (
            "type_names.csv",
            include_str!("../../../assets/pokeapi-current-data/type_names.csv"),
        ),
        (
            "move_damage_classes.csv",
            include_str!("../../../assets/pokeapi-current-data/move_damage_classes.csv"),
        ),
        (
            "pokemon_move_methods.csv",
            include_str!("../../../assets/pokeapi-current-data/pokemon_move_methods.csv"),
        ),
        (
            "pokemon_species_names.csv",
            include_str!("../../../assets/pokeapi-current-data/pokemon_species_names.csv"),
        ),
        (
            "move_names.csv",
            include_str!("../../../assets/pokeapi-current-data/move_names.csv"),
        ),
        (
            "moves.csv",
            include_str!("../../../assets/pokeapi-current-data/moves.csv"),
        ),
        (
            "pokemon_stats.csv",
            include_str!("../../../assets/pokeapi-current-data/pokemon_stats.csv"),
        ),
        (
            "pokemon_types.csv",
            include_str!("../../../assets/pokeapi-current-data/pokemon_types.csv"),
        ),
        (
            "pokemon.csv",
            include_str!("../../../assets/pokeapi-current-data/pokemon.csv"),
        ),
        (
            "pokemon_moves.csv",
            include_str!("../../../assets/pokeapi-current-data/pokemon_moves.csv"),
        ),
    ];
